...
/* emulate the original gld for the given elf32fusion
...
static void
gldelf32fusion_map_segments (bfd_boolean need_layout)
{
  int tries = 10;
...
static void
gldelf32fusion_after_open (void)
{
  bfd *ibfd;
  asection *sec;
  asymbol **syms;
...
static void
gldelf32fusion_before_allocation (void)
{
  if (bfd_link_relocatable (&link_info)
...
static void
gldelf32fusion_after_allocation (void)
{
  gldelf32fusion_map_segments (FALSE);
}

static void
gldelf32fusion_before_parse (void)
{
#ifndef TARGET_			/* I.e., if not generic.  */
  ldfile_set_output_arch ("fusion", bfd_arch_unknown);
#endif /* not TARGET_ */
}


static char *
gldelf32fusion_get_script (int *isfile)
{
  *isfile = 0;
...
OUTPUT_FORMAT(\"elf32-fusion\", \"elf32-fusion\",\n\
	      \"elf32-fusion\")\n\
OUTPUT_ARCH(fusion)\n\
...
OUTPUT_ARCH(fusion)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"/home/bit0fun/binutils/fusion-elf/lib\");\n\
SECTIONS\n\
{\n\
  /* Read-only sections, merged into text segment: */\n\
  PROVIDE (__executable_start = SEGMENT_START(\"text-segment\", )); . = SEGMENT_START(\"text-segment\", );\n\
  .interp         : { *(.interp) }\n\
  .note.gnu.build-id : { *(.note.gnu.build-id) }\n\
  .hash           : { *(.hash) }\n\
  .gnu.hash       : { *(.gnu.hash) }\n\
...
struct ld_emulation_xfer_struct ld_elf32fusion_emulation =
{
  gldelf32fusion_before_parse,
  syslib_default,
  hll_default,
  after_parse_default,
  gldelf32fusion_after_open,
  gldelf32fusion_after_allocation,
  set_output_arch_default,
  ldemul_default_target,
  gldelf32fusion_before_allocation,
  gldelf32fusion_get_script,
  "elf32fusion",
  "elf32-fusion",
  finish_default,
  NULL,
